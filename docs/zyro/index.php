...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		'0'	=> array('id' => '2', 'alias' => 'Home', 'file' => '2.php'),
		'1'	=> array('id' => '2', 'alias' => 'About', 'file' => '2.php'),
		'2'	=> array('id' => '2', 'alias' => 'Gallery', 'file' => '2.php'),
		'3'	=> array('id' => '2', 'alias' => 'Contacts', 'file' => '2.php')
	);
	$forms = array(
	...
	$base_url = '/';
	$user_domain = 'anilwedsramyacom.000webhostapp.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '2';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "j+qCSNxBviq/pnc8ejmF9VZgldSuO63Qhj2zXKypsgc2eA==";
	$user_hash = "77b464ce7dbdb829";
